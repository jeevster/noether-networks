...
#task1 (pure data loss): --emb_type pde_const_emb  
...
python train_noether_net_checkpointing_1d.py \
--tailor \
--emb_type pde_emb \
...
--ckpt_outer_loss \
--ckpt_inner_loss \
--log_dir /data/divyam123/results_noether_summer/best_results/non_meta_baseline/PINO/sgd_data_outer_learned_inner \
--warmstart_emb_path best_ckpt_model_advection.pt \
--channels 1 \
--random_weights \
