...
def desired_func(config):
        ...
        input_params = [
                ...
                '--log_dir','/data/divyam123/results_noether_summer/advection/pretrained_embedding_tune_final_2_2/data_true(outer)_true(inner)',
                '--channels','1',
                '--random_weights',
    ...
    tuner = tune.Tuner(
        ...
        tune_config=tune.TuneConfig(
                ...
                run_config = RunConfig(
                                    ...
                                    name = "advection_data(outer)_true(inner)",
                                )
    )
    results = tuner.fit()
