...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir $STOREDIR/slurm_runs_fixed_outer_residual_ood/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/no_norm_steps=5/run_pinns/ \
