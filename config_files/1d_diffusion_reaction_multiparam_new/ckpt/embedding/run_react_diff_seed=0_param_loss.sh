...
do
    ...
    --use_partials \
    --log_dir /data/divyam123/slurm_runs/results_noether_summer/1d_diffusion_reaction_multiparam_new/pre_trained_embeddings/seed=$SEED/pretrained_embedding_param_loss \
    --channels 1 \
    --tailor \
    --random_weights \
