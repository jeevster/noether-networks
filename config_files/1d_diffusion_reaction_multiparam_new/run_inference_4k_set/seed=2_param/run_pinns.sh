...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/slurm_baseline_4k/seed=$SEED/param_no_norm_steps=5/run_pinns/ \
--reload_dir /data/divyam123/slurm_runs/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/param_no_norm_steps=5/run_pinns/final/ckpt_model.pt \
--channels 1 \
--random_weights \
