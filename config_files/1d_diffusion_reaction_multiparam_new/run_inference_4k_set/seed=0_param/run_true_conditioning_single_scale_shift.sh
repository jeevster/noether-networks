...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/slurm_baseline_4k/seed=$SEED/param_no_norm_steps=5/run_true_conditioning_single_scale_shift \
--reload_dir /data/divyam123/slurm_runs/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/param_no_norm_steps=5/run_true_conditioning_single_scale_shift/final/ckpt_model.pt \
--channels 1 \
--random_weights \
