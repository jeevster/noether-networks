...
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/TRIAL/no_norm_steps=1/data_outer_true_inner_num_steps=1_no_norm_opt=adam_weights=cn/ \
