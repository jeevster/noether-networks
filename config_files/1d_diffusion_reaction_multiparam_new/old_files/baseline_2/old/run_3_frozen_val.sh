...
--num_learned_parameters 1 \
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/ckpt/no_norm_steps=5/data_outer_learned_frozen_val_inner_num_steps=5_no_norm_opt=adam_weights=cn/Thu-Mar--7-07.17.46-2024_past=2_future=2_tailor=PDE_1 \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_2_fixed/no_norm_steps=5/data_outer_learned_frozen_val_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \
