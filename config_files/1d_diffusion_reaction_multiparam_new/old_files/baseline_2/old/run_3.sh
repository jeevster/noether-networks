...
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_2_random/no_norm_steps=5/data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \
# config_files/1d_diffusion_reaction_multiparam_new/baseline_2/run_3.sh