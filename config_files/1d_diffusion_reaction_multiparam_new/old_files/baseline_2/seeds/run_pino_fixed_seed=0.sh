...
--reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=0/no_norm_steps=5/PINO_fixed/Fri-Mar-15-05.20.30-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
