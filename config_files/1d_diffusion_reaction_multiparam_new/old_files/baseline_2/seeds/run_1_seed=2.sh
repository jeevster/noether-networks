...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/baseline_2/seed=$SEED/no_norm_steps=5/PINNS_no_norm/ \
--reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=2/no_norm_steps=5/PINNS_no_norm/Thu-Mar-14-18.25.45-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
