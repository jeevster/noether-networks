...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=1/pretrained_embedding_mse/Thu-Mar-14-03.13.18-2024_past=2_future=2_tailor=PDE/best_ckpt_model.pt \
