...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=0/pretrained_embedding_mse/Thu-Mar-14-03.18.57-2024_past=2_future=2_tailor=PDE/best_ckpt_model.pt \
