...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/baseline_2/seed=$SEED/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2 \
--reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=0/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2/Thu-Mar-14-07.12.29-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
