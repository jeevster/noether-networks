...
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_REACTION/TRIAL/layer_norm_steps=1/data_outer_learned_inner_num_steps=1_layer_norm_opt=adam_weights=cn/ \
