...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/run_data_outer_train=learnable_val=frozen_param+residual_loss_init_frames.out
...
--use_partials \
--save_checkpoint \
--log_dir $STOREDIR/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/no_norm_steps=5/run_data_outer_train=learnable_val=frozen_param+residual_loss_init_frames/ \
--warmstart_emb_path $STOREDIR/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/pretrained_embedding_mse/final/best_ckpt_model.pt \
--channels 1 \
--random_weights \
