...
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/TRIAL/conditioning_comp/learned_conditioning_instance_norm/true_norm=no_norm_past=2_fut=2 \
