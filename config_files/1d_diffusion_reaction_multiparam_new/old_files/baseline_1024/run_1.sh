...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/ckpt/no_norm_steps=5/PINNS_no_norm/Mon-Feb-26-06.09.42-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_1024_fixed/no_norm_steps=5/PINNS_no_norm/ \
--channels 1 \
--random_weights \
