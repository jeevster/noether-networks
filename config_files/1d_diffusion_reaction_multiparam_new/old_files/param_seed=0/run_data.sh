...
# --ckpt_outer_loss \
# --ckpt_inner_loss \
# --ckpt_every 10 \--relative_data_loss \config_files/1d_diffusion_reaction_multiparam_new/ckpt/param_seed=0/run_data.sh
...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/slurm_runs_try_2/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/param_no_norm_steps=5/run_data/ \
--warmstart_emb_path /data/divyam123/slurm_runs_try_2/results_noether_summer/1d_diffusion_reaction_multiparam_new/pre_trained_embeddings/seed=$SEED/pretrained_embedding_param_loss/final/best_ckpt_model.pt \
--channels 1 \
--random_weights \
...
# --use_partials \
# --save_checkpoint \
# --log_dir /data/divyam123/slurm_runs/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/param_no_norm_steps=5/run_data/ \
