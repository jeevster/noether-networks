...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/slurm_runs/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=learnable_val=learnable_init_frames/ \
