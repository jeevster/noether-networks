...
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/TRIAL/no_norm_steps=5/learned_conditioning/true_norm=no_norm_past=2_fut=2 \
