...
--num_learned_parameters 1 \
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/TRIAL_extra/no_norm_steps=5/true_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--warmstart_emb_path best_1d_diff_react_multiparam.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
