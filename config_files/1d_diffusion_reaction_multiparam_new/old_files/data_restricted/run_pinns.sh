...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/trajectory_restriction_baseline/pinns_traj=$TRAJ_RESTRICTION/ \
--channels 1 \
--random_weights \
...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/trajectory_restriction_baseline/data_traj=$TRAJ_RESTRICTION/ \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \
