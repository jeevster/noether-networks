...
--log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_2_fixed/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2 \
--channels 1 \
--random_weights \
