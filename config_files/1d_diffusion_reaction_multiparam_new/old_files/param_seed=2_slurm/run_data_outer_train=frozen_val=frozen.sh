...
--use_partials \
--save_checkpoint \
--log_dir $STOREDIR/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=frozen_val=frozen/ \
