...
# --channels 1 \config_files/1d_diffusion_reaction_multiparam_new/ckpt/param_seed=1/run_data_outer_train=learnable_val=learnable_init_frames_no_pretraining.sh
# --random_weights \
...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/slurm_runs/results_noether_summer/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=learnable_val=learnable_init_frames_no_pretraining/ \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \