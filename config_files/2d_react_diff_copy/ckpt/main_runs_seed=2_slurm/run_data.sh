...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/2d_react_diff/run_data.out
...
--use_partials \
--log_dir /global/cfs/projectdirs/m4319/divyam123/slurm_runs_2d/2d_react_diff/seed=$SEED/run_data/ \
