...
--use_partials \
--log_dir /data/divyam123/slurm_runs/results_noether_summer/2d_react_diff/seed=$SEED/run_pinns \
--warmstart_emb_path /data/divyam123/slurm_runs/results_noether_summer/2d_react_diff/embeddings/pre_trained_embedding_param_loss_seed=$SEED/final/best_ckpt_model.pt \
--channels 2 \
--random_weights \
