...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/run3.out
...
--use_partials \
--log_dir /global/cfs/projectdirs/m4319/divyam123/2d_react_diff_multiparam/TRIAL/layer_norm_steps=5/data_outer_learned_inner_num_steps=5_layer_norm_opt=adam_weights=cn/ \
