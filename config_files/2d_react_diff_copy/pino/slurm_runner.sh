...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/run2_none.out
...
--use_partials \
--reload_latest \
--restore_path /global/cfs/projectdirs/m4319/divyam123/2d_react_diff_multiparam/TRIAL/no_norm_steps=5/data_outer_true_inner_num_steps=5_no_norm_opt=adam_weights=cn/Sat-Feb--3-05.31.03-2024_past=2_future=2_tailor=PDE_Const_1 \
--restore_epoch 190 \
--save_checkpoint \
--log_dir /global/cfs/projectdirs/m4319/divyam123/2d_react_diff_multiparam/TRIAL/no_norm_steps=5/data_outer_true_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
