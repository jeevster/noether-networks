...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/run1_no_norm.out
...
--ckpt_outer_loss \
--ckpt_inner_loss \
--log_dir /global/cfs/projectdirs/m4319/divyam123/2d_react_diff_multiparam/TRIAL/no_norm_steps=5/PINNS_no_norm/ \
