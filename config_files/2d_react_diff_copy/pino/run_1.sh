...
--num_learned_parameters 1 \
--use_partials \
--log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/TRIAL/layer_norm_steps=1/PINO \
...
# --num_learned_parameters 1 \
# --use_partials \
# --log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/TRIAL/no_norm_steps=1/PINO \
...
# --num_learned_parameters 1 \
# --use_partials \
# --log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/TRIAL/layer_norm_steps=5/PINO \
# --warmstart_emb_path best_1d_diff_react_multiparam.pt \
# --channels 2 \
# --random_weights \
# --batch_norm_to_group_norm \
