...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/2d_react_diff/run_run_true_conditioning_single_shift_scale.out
...
--use_partials \
--save_checkpoint \
--log_dir /global/cfs/projectdirs/m4319/divyam123/slurm_runs/results_noether_summer/2d_react_diff/seed=$SEED/run_true_conditioning_single_shift_scale/ \
