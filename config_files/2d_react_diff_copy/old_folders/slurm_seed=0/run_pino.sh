...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/2d_react_diff/run_pino.out
...
SEED=0
python train_noether_net_checkpointing_pino.py \
--num_tuning_steps 5 \
--fixed_window \
--pinn_outer_loss \
...
--use_partials \
--save_checkpoint \
--log_dir /global/cfs/projectdirs/m4319/divyam123/slurm_runs/results_noether_summer/2d_react_diff/seed=$SEED/run_pino/ \
