...
--num_learned_parameters 1 \
--use_partials \
--log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/TRIAL/no_norm_steps=1/data_outer_true_inner_num_steps=1_no_norm_opt=adam_weights=cn/ \
