...
--log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/baseline_2_fixed/no_norm_steps=5/data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--channels 2 \
--random_weights \
