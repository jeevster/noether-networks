...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/2d_react_diff/run_data_outer_val=learnable_train=frozen.out
...
--use_partials \
--log_dir /global/cfs/projectdirs/m4319/divyam123/results_noether_summer/2d_react_diff/seed=$SEED/run_data_outer_val=learnable_train=frozen/ \
