...
#SBATCH -q regular
#SBATCH -o /global/cfs/projectdirs/m4319/divyam123/2d_react_diff/run_data_outer_val=learnable_train=learnable_residual_loss_init_frames.out
...
--use_partials \
--log_dir /global/cfs/projectdirs/m4319/divyam123/results_noether_summer/2d_react_diff/seed=$SEED/run_data_outer_val=learnable_train=learnable_residual_loss_init_frames/ \
--warmstart_emb_path /global/cfs/projectdirs/m4319/divyam123/results_noether_summer/2d_react_diff/embeddings/pre_trained_embedding_seed=$SEED/final/best_ckpt_model.pt \
--channels 2 \
--random_weights \
