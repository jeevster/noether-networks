...
--use_partials \
--log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam_new/ckpt/seed=$SEED/run_data_outer_val=learnable_train=frozen_param_loss_init_frames/ \
