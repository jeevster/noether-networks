...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/2d_ckpt/PINO/Sun-Feb-25-18.57.55-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/baseline_2/no_norm_steps=5/PINNS_no_norm/ \
...
# --log_dir /data/divyam123/results_noether_summer/2d_react_diff_multiparam/baseline_2/no_norm_steps=5/true_conditioning/ \
# --warmstart_emb_path best_ckpt_model.pt \
# --channels 2 \
# --random_weights \
# --batch_norm_to_group_norm \
