...
--use_partials \
--log_dir  /data/divyam123/results_noether_summer/best_results/non_meta_baseline/data_true_outer_true_inner/run_advection_mode=data_true_outer_true_inner_inneropt=sgd_tailor=dynamics_only_norm=instance \
--warmstart_emb_path best_ckpt_model_advection.pt \
--channels 1 \
--random_weights \
