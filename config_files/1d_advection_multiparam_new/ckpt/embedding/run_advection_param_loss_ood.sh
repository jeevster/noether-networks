...
for SEED in 0 1 2
do
    CUDA_VISIBLE_DEVICES=9 python train_embedding.py \
    --seed $SEED \
    --param_loss \
    --gradient_clipping \
    --save_checkpoint \
    ...
    --use_partials \
    --log_dir /data/divyam123/slurm_runs_ood/results_noether_summer/1d_advection_new_params/pre_trained_embeddings/seed=$SEED/pretrained_embedding_param_loss \
    --channels 1 \
    --tailor \
    --random_weights \
