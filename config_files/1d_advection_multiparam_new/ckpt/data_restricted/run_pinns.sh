...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/trajectory_restriction/pinns_traj=$TRAJ_RESTRICTION/ \
...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/trajectory_restriction/data_traj=$TRAJ_RESTRICTION/ \
--warmstart_emb_path /data/divyam123/slurm_runs/results_noether_summer/1d_advection_new_params/pre_trained_embeddings/seed=$SEED/pretrained_embedding_mse/final/best_ckpt_model.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
