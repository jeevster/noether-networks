...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir /global/cfs/projectdirs/m4319/divyam123/slurm_runs_fixed_outer_residual_ood/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/no_norm_steps=5/run_pino \
