...
do
    ...
    --save_checkpoint \
    --ckpt_outer_loss \
    --log_dir /data/divyam123/slurm_runs_new_residual/results_noether_summer/1d_advection_new_params/baseline_4k_new_residual_15/seed=$SEED/no_norm_steps=5/run_pinns/ \
    --reload_dir /data/divyam123/slurm_runs_new_residual/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/no_norm_steps=5/run_pinns/final/best_outer_val_ckpt_model.pt \
    --channels 1 \
    --random_weights \
