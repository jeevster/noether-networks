...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/slurm_baseline_4k/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=learnable_val=learnable_init_frames/ \
--reload_dir /data/divyam123/slurm_runs/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=learnable_val=learnable_init_frames/final/ckpt_model.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \
