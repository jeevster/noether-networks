...
do
    ...
    --use_partials \
    --save_checkpoint \
    --log_dir /data/divyam123/slurm_runs_pinns/pinns_sweep/1d_advection_new_params/baseline_4k/seed=$SEED/param_no_norm_steps=5/run_pinns_data=${DATAREG}_pde=${PDEREG}/ \
    --reload_dir /data/divyam123/slurm_runs_pinns/pinns_sweep/1d_advection_new_params/ckpt/seed=$SEED/param_no_norm_steps=5/run_pinns_data=${DATAREG}_pde=${PDEREG}/final/best_outer_val_ckpt_model.pt \
    --channels 1 \
    --random_weights \
