...
# --channels 1 \
# --random_weights \
# --batch_norm_to_group_norm \ config_files/1d_advection_multiparam_new/baseline_4k/seed=0_param/run_data_outer_train=learnable_val=learnable_param_loss_init_frames.sh
...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/slurm_baseline_4k/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=learnable_val=learnable_param_loss_init_frames_no_pretraining/ \
--reload_dir /data/divyam123/slurm_runs/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=learnable_val=learnable_param_loss_init_frames_no_pretraining/final/ckpt_model.pt \
--channels 1 \
--random_weights \
