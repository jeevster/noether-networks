...
do
    ...
    --save_checkpoint \
    --ckpt_outer_loss \
    --log_dir $LOGDIR/run_data_outer_train=learnable_val=learnable_param_loss_init_frames_lr=$ilr/ \
    --reload_dir $RELOADDIR/run_data_outer_train=learnable_val=learnable_param_loss_init_frames_lr=$ilr/final/best_outer_val_ckpt_model.pt \
    --channels 1 \
    --random_weights \
