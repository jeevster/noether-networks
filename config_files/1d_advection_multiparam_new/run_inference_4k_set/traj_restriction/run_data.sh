...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/trajectory_restriction_baseline/seed=$SEED/run_data/ \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/trajectory_restriction/data_traj=0.4/final/ckpt_model.pt \
--channels 1 \
--random_weights \
...
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/trajectory_restriction_baseline/seed=$SEED/run_data/ \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/trajectory_restriction/data_traj=0.4/final/best_outer_val_ckpt_model.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \
