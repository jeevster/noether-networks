...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/trajectory_restriction_baseline/seed=$SEED/run_pinns/ \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/trajectory_restriction/pinns_traj=0.4/final/best_outer_val_ckpt_model.pt \
--channels 1 \
--random_weights \
