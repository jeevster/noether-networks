...
--num_learned_parameters 1 \
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_2_random/seed=$SEED/NO_NORM/no_norm_steps=5/PINO_fixed \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=1/NO_NORM/no_norm_steps=5/PINO_fixed/Fri-Mar-15-02.57.59-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
