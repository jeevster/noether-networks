...
--num_learned_parameters 1 \
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_2_random/seed=$SEED/NO_NORM/no_norm_steps=5/data_outer_learned_both_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=0/NO_NORM/no_norm_steps=5/data_outer_learned_both_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/Thu-Mar-14-05.26.50-2024_past=2_future=2_tailor=PDE_1 \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \
