...
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=2/NO_NORM/no_norm_steps=5/PINNS_no_norm/Thu-Mar-14-23.37.08-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
