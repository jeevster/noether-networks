...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=2/pretrained_embedding_mse/Thu-Mar-14-01.17.22-2024_past=2_future=2_tailor=PDE/best_ckpt_model.pt \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_2/seed=$SEED/pretrained_embedding_$LOSS \
--channels 1 \
--tailor \
--random_weights \
