...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=0/pretrained_embedding_log_param_mse/Thu-Mar-21-12.33.44-2024_past=2_future=2_tailor=PDE/best_ckpt_model.pt \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_2/seed=$SEED/pretrained_embedding_log_param_$LOSS \
--channels 1 \
--tailor \
--random_weights \
