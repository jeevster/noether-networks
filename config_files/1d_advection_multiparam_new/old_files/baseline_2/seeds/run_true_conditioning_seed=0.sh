...
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_2_random/seed=$SEED/NO_NORM/explicit_conditioning/true_norm=no_norm_past=2_fut=2 \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/seed=0/NO_NORM/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2/Thu-Mar-14-05.01.24-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
