...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/slurm_baseline/seed=$SEED/no_norm_steps=5/run_data_outer_train=learnable_val=learnable_residual_loss/ \
