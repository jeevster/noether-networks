...
--num_learned_parameters 1 \
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/NO_NORM/no_norm_steps=5/data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/Mon-Feb-26-06.44.52-2024_past=2_future=2_tailor=PDE_1/ \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_2/NO_NORM/no_norm_steps=5/data_outer_learned_inner/ \
--warmstart_emb_path best_ckpt_advection_multiparam_mse.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/NO_NORM/no_norm_steps=5/data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/Mon-Feb-26-06.44.52-2024_past=2_future=2_tailor=PDE_1/ \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_5/NO_NORM/no_norm_steps=5/data_outer_learned_inner/ \
--warmstart_emb_path best_ckpt_advection_multiparam_mse.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
...
# --use_partials \
# --reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/NO_NORM/no_norm_steps=5/data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/Mon-Feb-26-06.44.52-2024_past=2_future=2_tailor=PDE_1/ \
# --log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_1024/NO_NORM/no_norm_steps=5/data_outer_learned_inner/ \
# --warmstart_emb_path best_ckpt_advection_multiparam_mse.pt \
# --channels 1 \
# --random_weights \
# --batch_norm_to_group_norm \
