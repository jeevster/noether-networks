...
--use_partials \
--save_checkpoint \
--log_dir  $STOREDIR/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=learned_val=frozen_param_loss_init_frames/ \
