...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/TRIAL_extra/NO_NORM/no_norm_steps=5/data_outer_learned_val_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--warmstart_emb_path best_ckpt_advection_multiparam_mse.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
