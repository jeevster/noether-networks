...
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_1024_fixed/NO_NORM/explicit_conditioning/true_norm=no_norm_past=2_fut=2 \
--channels 1 \
--random_weights \
