...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_advection_new_params/ckpt/NO_NORM/no_norm_steps=5/PINNS_no_norm/Mon-Feb-26-06.18.55-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--log_dir /data/divyam123/results_noether_summer/1d_advection_new_params/baseline_1024_fixed/NO_NORM/no_norm_steps=5/PINNS_no_norm/ \
--channels 1 \
--random_weights \
