...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/slurm_runs/results_noether_summer/1d_advection_new_params/ckpt/seed=$SEED/no_norm_steps=5/run_data_outer_train=learned_val=learned_residual_param_loss/ \
