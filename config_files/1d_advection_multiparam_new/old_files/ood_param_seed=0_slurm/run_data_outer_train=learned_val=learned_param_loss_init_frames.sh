...
--warmstart_emb_path $STOREDIR/results_noether_summer/1d_advection_new_params/pre_trained_embeddings/seed=$SEED/pretrained_embedding_param_losss/final/best_ckpt_model.pt \
--channels 1 \
--random_weights \
