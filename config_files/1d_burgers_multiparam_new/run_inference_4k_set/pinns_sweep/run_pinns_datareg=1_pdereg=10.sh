...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/pinns_sweep_baseline/seed=$SEED/param_no_norm_steps=5/run_pinns_data=${DATAREG}_pde=${PDEREG}/ \
