...
--use_partials \
--save_checkpoint \
--log_dir $STOREDIR/results_noether_summer/1d_burgers_new_params_clean/slurm_baseline_4k/seed=$SEED/no_norm_steps=5/run_data_outer_train=frozen_val=frozen_init_frames/ \
--reload_dir $STOREDIR/slurm_runs/results_noether_summer/1d_burgers_new_params_clean/ckpt/seed=$SEED/no_norm_steps=5/run_data_outer_train=frozen_val=frozen_init_frames/final/ckpt_model.pt \
--channels 1 \
--random_weights \
