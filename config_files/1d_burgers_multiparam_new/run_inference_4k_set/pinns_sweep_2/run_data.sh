...
do
    ...
    --use_partials \
    --save_checkpoint \
    --log_dir /data/divyam123/slurm_runs_pinns/pinns_sweep/1d_burgers_new_params_clean/baseline_2/seed=$SEED/param_no_norm_steps=5/run_data/ \
    --reload_dir /data/divyam123/slurm_runs_pinns/pinns_sweep/1d_burgers_new_params_clean/ckpt/seed=$SEED/param_no_norm_steps=5/run_data/final/best_outer_val_ckpt_model.pt \
    --channels 1 \
    --random_weights \
