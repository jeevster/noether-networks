...
--use_partials \
--save_checkpoint \
--log_dir $STOREDIR/results_noether_summer/1d_burgers_new_params_clean/slurm_baseline_4k/seed=$SEED/no_norm_steps=5/run_data_outer_train=learned_val=learned_residual_loss/ \
