...
for SEED in 0 1 2
do
    CUDA_VISIBLE_DEVICES=7 python train_embedding.py \
    --ood \
    --seed $SEED \
    --param_loss \
    --gradient_clipping \
    ...
    --use_partials \
    --log_dir /data/divyam123/slurm_runs_ood/results_noether_summer/1d_burgers_multiparam_clean/ckpt/seed=$SEED/pretrained_embedding_param_loss \
    --channels 1 \
    --tailor \
    --random_weights \
