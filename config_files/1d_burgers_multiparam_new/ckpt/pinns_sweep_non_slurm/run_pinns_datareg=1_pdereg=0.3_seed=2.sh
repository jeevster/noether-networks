...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir /data/divyam123/slurm_runs_pinns/pinns_sweep/1d_burgers_new_params_clean/ckpt/seed=$SEED/param_no_norm_steps=5/run_pinns_data=${DATAREG}_pde=${PDEREG}/ \
--channels 1 \
--random_weights \
