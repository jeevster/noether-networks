...
STOREDIR=/data/divyam123/fixed_pinns_sweep
...
--save_checkpoint \
--ckpt_outer_loss \
--log_dir $STOREDIR/pinns_sweep/1d_burgers_new_params_clean/ckpt/seed=$SEED/param_no_norm_steps=5/run_pinns_data=${DATAREG}_pde=${PDEREG}/ \
