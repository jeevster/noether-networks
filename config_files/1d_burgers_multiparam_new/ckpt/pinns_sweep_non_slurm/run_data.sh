...
for SEED in 0 1 2
do
    LOGDIR=/data/divyam123/slurm_runs_pinns/pinns_sweep/1d_burgers_new_params_clean/ckpt/seed=$SEED/param_no_norm_steps=5
...
do
    ...
    --save_checkpoint \
    --ckpt_outer_loss \
    --log_dir /data/divyam123/slurm_runs_pinns/pinns_sweep/1d_diffusion_reaction_multiparam_new/ckpt/seed=$SEED/no_norm_steps=5/run_data_ood/ \
