...
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/TRIAL/no_norm_steps=5/mse_data_outer_learned_both_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
