...
--num_learned_parameters 1 \
--use_partials \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/TRIAL/no_norm_steps=5/mse_data_outer_learned_val_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--warmstart_emb_path best_ckpt_burgers_multiparam_mse.pt \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
