...
--use_partials \
--save_checkpoint \
--log_dir $STOREDIR/results_noether_summer_2/1d_burgers_new_params_clean/ckpt/seed=$SEED/param_no_norm_steps=5/run_data_outer_train=frozen_val=frozen_init_frames/ \
