...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/pinns_sweep_baseline_15_2k/seed=$SEED/param_no_norm_steps=5/run_data/ \
--reload_dir /data/divyam123/slurm_runs/pinns_sweep/1d_burgers_new_params_clean/ckpt/seed=$SEED/param_no_norm_steps=5/run_data/final/ckpt_model.pt \
--channels 1 \
--random_weights \
