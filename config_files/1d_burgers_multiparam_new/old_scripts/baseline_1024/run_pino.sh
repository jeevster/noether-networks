...
--num_learned_parameters 1 \
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/ckpt/no_norm_steps=5/mse_PINO/Tue-Feb-27-05.53.01-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/baseline_1024_fixed/no_norm_steps=5/mse_PINO \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
