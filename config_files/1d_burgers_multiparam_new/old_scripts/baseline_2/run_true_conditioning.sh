...
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/baseline_2_random/no_norm_steps=5/mse_explicit_conditioning/true_norm=no_norm_past=2_fut=2/Mon-Feb-26-06.49.07-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
