...
# --use_partials \
# --save_checkpoint \
# --log_dir /data/divyam123/results_noether_summer/pinns_sweep/1d_diffusion_reaction_multiparam_new/run_pinns_data=${DATAREG}_pde=${PDEREG}/ \
# --channels 1 \
# --random_weights \
...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/pinns_sweep/1d_diffusion_reaction_multiparam_new/run_data/ \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \