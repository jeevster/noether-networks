...
LOGDIR=/data/divyam123/results_noether_summer/pinns_sweep/1d_burgers_new_params_clean
EMBDIR=/data/divyam123/results_noether_summer/pinns_sweep/1d_burgers_multiparam_clean/ckpt/seed=$SEED/pretrained_embedding_param_loss/final/best_ckpt_model.pt
