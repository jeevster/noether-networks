...
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/baseline_2/no_norm_steps=5/mse_data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
