...
--num_learned_parameters 1 \
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/ckpt/no_norm_steps=5/mse_PINO/Thu-Mar--7-12.33.18-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/baseline_2_random/no_norm_steps=5/mse_PINO \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
