...
--num_learned_parameters 1 \
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/ckpt/no_norm_steps=5/mse_data_outer_learned_val_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/Thu-Mar--7-12.21.30-2024_past=2_future=2_tailor=PDE_1 \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/baseline_2_random/no_norm_steps=5/mse_data_outer_learned_frozen_val_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
--model_path ./checkpoints/pdes/t_past2/batch_5d \
...
# --num_learned_parameters 1 \
# --use_partials \
# --reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/ckpt/no_norm_steps=5/mse_data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/Tue-Feb-27-02.31.18-2024_past=2_future=2_tailor=PDE_1 \
# --log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/baseline_5/no_norm_steps=5/mse_data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
...
# --num_learned_parameters 1 \
# --use_partials \
# --reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/ckpt/no_norm_steps=5/data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/Mon-Feb-26-06.37.27-2024_past=2_future=2_tailor=PDE_1 \
# --log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_1024/no_norm_steps=5/data_outer_learned_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
# --warmstart_emb_path best_1d_diff_react_multiparam.pt \
# --channels 1 \
# --random_weights \
# --batch_norm_to_group_norm \
