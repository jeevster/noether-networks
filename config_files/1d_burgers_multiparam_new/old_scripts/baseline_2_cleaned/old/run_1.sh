...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/ckpt/no_norm_steps=5/PINNS_no_norm_mse/Thu-Mar--7-12.22.58-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/baseline_2_random/no_norm_steps=5/PINNS_no_norm_mse/ \
--channels 1 \
--random_weights \
...
# --num_learned_parameters 1 \
# --use_partials \
# --reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/ckpt/no_norm_steps=5/PINNS_no_norm_mse/Mon-Feb-26-06.16.31-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
# --log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/baseline_5/no_norm_steps=5/PINNS_no_norm_mse/ \
...
# --num_learned_parameters 1 \
# --use_partials \
# --reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/ckpt/no_norm_steps=5/mse_PINO/Mon-Feb-26-06.48.36-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
# --log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params/baseline_1024/no_norm_steps=5/PINNS_no_norm_mse/ \
# --warmstart_emb_path best_ckpt_burgers_multiparam_mse.pt \
# --channels 1 \
# --random_weights \
# --batch_norm_to_group_norm \
...
# --log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_2/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2 \
...
# --use_partials \
# --reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/ckpt/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2/Mon-Feb-26-08.06.12-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
# --log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_5/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2 \
# --warmstart_emb_path best_1d_diff_react_multiparam.pt \
# --channels 1 \
# --random_weights \
# --batch_norm_to_group_norm \
...
# --use_partials \
# --reload_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/ckpt/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2/Mon-Feb-26-08.06.12-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
# --log_dir /data/divyam123/results_noether_summer/1d_diffusion_reaction_new_params/baseline_1024/no_norm_steps=5/explicit_conditioning/true_norm=no_norm_past=2_fut=2 \
# --warmstart_emb_path best_1d_diff_react_multiparam.pt \
# --channels 1 \
# --random_weights \
# --batch_norm_to_group_norm \
