...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/baseline_2_random/seed=$SEED/no_norm_steps=5/mse_data_outer_learned_both_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/ \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/ckpt/seed=1/no_norm_steps=5/mse_data_outer_learned_both_frozen_inner_num_steps=5_no_norm_opt=adam_weights=cn/Thu-Mar-14-11.56.31-2024_past=2_future=2_tailor=PDE_1 \
--channels 1 \
--random_weights \
