...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_multiparam_clean/ckpt/seed=1/pretrained_embedding_mse/Thu-Mar-14-06.20.59-2024_past=2_future=2_tailor=PDE/best_ckpt_model.pt \
