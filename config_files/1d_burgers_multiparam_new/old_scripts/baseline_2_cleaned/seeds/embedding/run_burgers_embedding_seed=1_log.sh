...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_multiparam_clean/ckpt/seed=1/pretrained_embedding_log_param_mse/Thu-Mar-21-12.33.20-2024_past=2_future=2_tailor=PDE/best_ckpt_model.pt \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_multiparam_clean/baseline_2_random/seed=$SEED/pretrained_embedding_log_param_$LOSS \
--channels 1 \
--tailor \
--random_weights \
