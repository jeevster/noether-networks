...
--use_partials \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_multiparam_clean/ckpt/seed=0/pretrained_embedding_log_param_mse/Thu-Mar-21-12.43.06-2024_past=2_future=2_tailor=PDE/best_ckpt_model.pt \
