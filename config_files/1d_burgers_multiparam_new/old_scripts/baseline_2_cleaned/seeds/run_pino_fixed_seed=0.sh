...
# --g_dim 128 \
# --z_dim 64 \
# --dataset 1d_burgers_multiparam \ 2d_reacdiff_multiparam \
# --data_root $DATADIR \
# --num_trials 1 \
# --n_past 2 \
# --n_future 2 \
...
--use_partials \
--save_checkpoint \
--log_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/baseline_2_random/seed=$SEED/no_norm_steps=5/mse_PINO_fixed \
--reload_dir /data/divyam123/results_noether_summer/1d_burgers_new_params_clean/ckpt/seed=0/no_norm_steps=5/mse_PINO_fixed/Fri-Mar-15-07.06.01-2024_past=2_future=2_tailor=None_PINN_Outer_Loss_Weight=1.0 \
--channels 1 \
--random_weights \
--batch_norm_to_group_norm \
